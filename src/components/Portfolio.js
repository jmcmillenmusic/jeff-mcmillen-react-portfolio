...
function Portfolio() {
    return (
        <section className="portfolio" id="portfolio">
            <h2 className="border1">Portfolio</h2>
            <div className="project-list">
                <div className="projectCard">
                    ...
                    <img src={projImg1} alt="Supercomputer server room with TACC logo in the middle" className="border1 screenshot"></img>
                    <p className="border1">Repository for TACC's Core Portal system where I am currently contributing to the development and improvement of portal functionality to grant researchers access to high-powered computers
                    <br /><br />
                ...
                <div className="projectCard">
                    ...
                    <img src={projImg1} alt="Supercomputer server room with TACC logo in the middle" className="border1 screenshot"></img>
                    <p className="border1">Repository for TACC's Core Custom Content Management System where I am developing new features and improvement of functionality of the All-Payor Claims Database in conjunction with UTHealth Houston's School of Public Health
                    <br /><br />
                    <em>Technologies Utilized: Python, Django, Docker, React, JavaScript, TypeScript</em>
                    <br /><br />
                    <a href="https://github.com/TACC/Core-CMS-Custom/pulls?q=is%3Apr+author%3Ajmcmillenmusic" target="_blank" rel="noopener noreferrer">
                ...
                <div className="projectCard">
                    ...
                    <img src={projImg2} alt="Tech Blog with a list of tech-related posts and a navbar at the top" className="border1 screenshot"></img>
                    <p className="border1">Tech blog where users can create an account, log in, see all of their posts, create new posts and comment on other posts, update their posts, and delete their posts
                    <br /><br />
                ...
                <div className="projectCard">
                    ...
                    <img src={projImg3} alt="Table of employees with names, titles, salaries, and managers" className="border1 screenshot"></img>
                    <p className="border1">Back-end application where a user can view or add departments, roles, and employees as well as update an employee's role
                    <br /><br />
                ...
                <div className="projectCard">
                    ...
                    <img src={projImg4} alt="Screenshot of a thought-provoking question and answer" className="border1 screenshot"></img>
                    <p className="border1">Back-end application where a user can create, read, update, and delete users, thoughts, and reactions (similar to posts and comments on social media)
                    <br /><br />
