        ...
        <section className="portfolio" id="portfolio">
            ...
            <div className="project-list">
                ...
                <div className="projectCard">
                    ...
                    <br /><br />
                    <u>Technologies Utilized</u>: Hypertext Markup Language (HTML5), Cascading Style Sheets (CSS3), Bulma, JavaScript, Application Programming Interfaces (APIs)</p>
                </div>
                <div className="projectCard">
                    <h3 className="hex2 border1">
                    ...
                    <br /><br />
                    <u>Technologies Utilized</u>: Node.js, Express.js, SQL, Inquirer, JavaScript</p>
                </div>
                <div className="projectCard">
                    <h3 className="hex2 border1">
                    ...
                    <br /><br />
                    <u>Technologies Utilized</u>: Node.js, Express.js, MongoDB, Insomnia, JavaScript</p>
                </div>
                <div className="projectCard">
                    <h3 className="hex2 border1">
                    ...
                    <br /><br />
                    <u>Technologies Utilized</u>: Node.js, Express.js, Sequelize.js, Insomnia, Object-Relational Mapping (ORM), JavaScript</p>
                </div>
                <div className="projectCard">
                    <h3 className="hex2 border1">
                        MVC Tech Blog
                    ...
                    <br /><br />
                    <u>Technologies Utilized</u>: Node.js, Express.js, Sequelize.js, SQL, Handlebars.js, JavaScript</p>
                </div>
            </div>
        </section>
    )
