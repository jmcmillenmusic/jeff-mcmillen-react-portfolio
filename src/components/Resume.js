...
import resume from "../files/McMillen_Jeff_WebDev_Resume_v.4.0.1.pdf";
...
function Resume() {
    return (
        <section className="resume" id="resume">
            <a href="../files/McMillen_Jeff_WebDev_Resume_v.4.0.1.pdf" download={resume} target="_blank"><img src={img} alt="Icon for a resume" className="resumeIcon border1"></img></a>
